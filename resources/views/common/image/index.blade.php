...
<div class="d-padding-10 d-hidden">
  <div class="d-margin-b-10"><a class="layui-btn layui-btn-normal" href="{{ url('admin/image/create?model='.$model.'&mark='.$mark.'&info_id='.$info_id.'&field='.$field.'&type='.$type) }}">添加图片</a></div>
