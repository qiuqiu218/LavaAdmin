...
@section('content')
<form class="layui-form layui-form-pane" action="{{url('admin/permission_classify/'.$data->id)}}" method="post">
  {{ csrf_field() }}
  {{ method_field('PUT') }}
  ...
  <div class="d-padding-10">
    <div class="layui-form-item">
      ...
      <div class="layui-input-inline">
        <input type="text" name="name" required lay-verify="required" placeholder="请输入分类名称" class="layui-input" value="{{old('name') ? old('name') : $data->name}}">
      </div>
