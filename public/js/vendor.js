...
/* WEBPACK VAR INJECTION */(function(global) {module.exports = global["jQuery"] = __webpack_require__(155);
...
/* WEBPACK VAR INJECTION */(function(global) {module.exports = global["$"] = __webpack_require__(156);
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(50)))
...
if (!(TO_PRIMITIVE in proto)) __webpack_require__(12)(proto, TO_PRIMITIVE, __webpack_require__(241));
...
$.extend({
  store: {
    get: function get() {
      return _store2.default.apply(undefined, arguments);
    },
    set: function set() {
      _store2.default.apply(undefined, arguments);
    },
    has: function has(key) {
      return _store2.default.has(key);
    },
    ...
    array: {
      ...
      remove: function remove(key, id) {
        ...
        var collect = this.get(key);
        $.store.set(key, collect.filter(function (res) {
          return res[field] !== id;
        }));
      },
      has: function has(key, id) {
        var field = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 'id';

        var collect = this.get(key);
        return collect.some(function (res) {
          return res[field] === id;
        });
      },
      toggle: function toggle(key, data) {
        var field = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 'id';
...
$(".layui-form").on('keyup', 'textarea', function () {
  var wordCount = $(this).siblings('.word-count');
